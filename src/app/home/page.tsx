...
const Home = () => {
    return (
        <div 
            className="min-h-screen pt-4 pb-3 lg:py-6 px-4 lg:px-9 bg-center lg:rounded-tl-3xl lg:border-l-2 lg:border-t-2 border-border overflow-x-hidden bg-prodify-light grid-pattern"
        >
